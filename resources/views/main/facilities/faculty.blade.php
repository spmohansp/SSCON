...
@section('title')Sri Shanmugha College of Nursing - Faculty @endsection
...
@section('MobileTitle') Faculty @endsection
...
@section('BreadCrumb')
    <section class="breadcrumb-classic context-dark">
        <div class="shell section-30 section-sm-top-70 section-sm-bottom-60">
            <h1 class="veil reveal-sm-block"> Faculty</h1>
            ...
            <div class="range">
                <div class="cell-sm-4 cell-sm-push-2 text-sm-left"><br><br>
                    <div class="inset-sm-left-30"><img src="{{ url('/images/nursing/nursing-lab-2.jpg') }}" width="450" height="400" alt="Shanmugha nursing faculty" class="img-responsive reveal-inline-block img-rounded">
                            ...
                            <h6 class="text-primary text-bold">Faculty</h6>
                        </div>
                    </div>
                </div>
                <div class="cell-sm-8 cell-sm-push-1 offset-top-50 offset-sm-top-0 text-sm-left">
                    <h2 class="text-bold">Faculty</h2>
                    <hr class="divider bg-madison hr-sm-left-0">
                    <div class="offset-top-30 offset-sm-top-60">
                        <p align="justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;The transformation of students as outstanding professionals truly lies in the hands of the faculty in any educational institution. The Shanmugha college of Nursing for women has distinct faculty with Post graduate qualification coupled with vast experience gleaned from the clinical field.</p>
                    </div>
